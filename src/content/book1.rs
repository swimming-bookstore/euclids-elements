...
pub const PROP_5: Proposition = Proposition {
    ...
    phrases: &[
        ...
        s(3, "And since the whole of *AF* is equal to the whole of *AG*, within which *AB* is equal to *AC*,"),
        s(3, "the remainder *BF* is thus equal to the remainder *CG*.{[C.N. 3]}"),
        s(3, "But *FC* was also shown (to be) equal to *GB*."),
        s(3, "So the two (straight-lines) *BF*, *FC* are equal to the two (straight-lines) *CG*, *GB*, respectively,"),
        s(3, "and the angle *BFC* (is) equal to the angle *CGB*,"),
        s(3, "and the base *BC* is common to them."),
        s(3, "Thus, the triangle *BFC* will be equal to the triangle *CGB*,"),
        s(3, "and the remaining angles subtended by the equal sides will be equal to the corresponding remaining angles.{[Prop. 1.4]}"),
        s(3, "Thus, *FBC* is equal to *GCB*, and *BCF* to *CBG*."),
        s(3, "Therefore, since the whole angle *ABG* was shown (to be) equal to the whole angle *ACF*,"),
        s(3, "within which *CBG* is equal to *BCF*,"),
        s(3, "the remainder *ABC* is thus equal to the remainder *ACB*.{[C.N. 3]}"),
        s(3, "And they are at the base of triangle *ABC*."),
        s(3, "And *FBC* was also shown (to be) equal to *GCB*."),
        s(3, "And they are under the base."),
        s(4, "Thus, for isosceles triangles, the angles at the base are equal to one another,"),
        s(4, "and if the equal sides are produced then the angles under the base will be equal to one another."),
